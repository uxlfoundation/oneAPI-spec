...
parameter that is passed to the primitive descriptor initialization function
like |batch_normalization_forward::primitive_desc|. Multiple flags can
...
- :math:`\gamma(c)` and :math:`\beta(c)` are optional scale and shift for a
  channel (controlled using the |use_scale| and |use_shift| flags),
...
|use_scale| and |use_shift| are set).
...
+----------------------------------------------------+--------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
|``flags`` \| |fuse_norm_relu|                       | *In*: same as with ``flags``; *Out*: same as with ``flags``                                            | *In*: same as with ``flags``; *Out*: same as with ``flags``, workspace                                | *In*: same as with ``flags``, workspace; *Out*: same as with ``flags``                                                                                             | Same as for |backward| if ``flags`` do not contain |use_scale| or |use_shift|; not supported otherwise |
+----------------------------------------------------+--------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
...
2. The memory format and data type for ``src`` and ``dst`` are assumed to be
   ...
   see ``data_desc`` in |batch_normalization_forward::primitive_desc|).
