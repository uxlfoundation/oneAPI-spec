...
Extracting the header containing the encoding parameter set from the encoded
bitstream is usually the task of a format splitter (de-multiplexer). Alternatively,
the SDK :cpp:func:`MFXVideoDECODE_DecodeHeader` function can export
