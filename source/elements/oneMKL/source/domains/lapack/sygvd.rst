...
.. container::
   ...
   .. container:: section
      ...
      .. cpp:function::  void onemkl::lapack::sygvd(cl::sycl::queue &queue, std::int64_t itype,      onemkl::job jobz, onemkl::uplo upper_lower, std::int64_t n, cl::sycl::buffer<T,1> &a,      std::int64_t lda, cl::sycl::buffer<T,1> &b, std::int64_t ldb, cl::sycl::buffer<T,1>      &w, cl::sycl::buffer<T,1> &scratchpad, std::int64_t scratchpad_size)
...
.. container::
   ...
   .. container:: section
      ...
      .. cpp:function::  cl::sycl::event onemkl::lapack::sygvd(cl::sycl::queue &queue, std::int64_t itype,      onemkl::job jobz, onemkl::uplo upper_lower, std::int64_t n, T *a,      std::int64_t lda, T *b, std::int64_t ldb, T *w, T *scratchpad, std::int64_t scratchpad_size, const cl::sycl::vector_class<cl::sycl::event> &events = {})
...
.. container:: section
   ...
   w
      Pointer to array of size at least ``n``. If ``info = 0``, contains the
      eigenvalues of the matrix ``A`` in ascending order.
