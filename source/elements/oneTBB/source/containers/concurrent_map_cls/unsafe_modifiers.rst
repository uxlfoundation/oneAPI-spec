...
-----------------------------------------------------
    ...
    Removes the element with the key which compares equivalent to ``key``
    ...
    **Returns**: ``1`` if an element with the key which compares equivalent to ``key`` exists,
    ``0`` otherwise.
...
-----------------------------------------------------
    ...
    If an element with the key equal to ``key`` exists, transfers ownership of this element
...
-----------------------------------------------------
    ...
    If an element with the key which compares equivalent to ``key`` exists,
