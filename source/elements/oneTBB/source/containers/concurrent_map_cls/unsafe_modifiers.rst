...
-----------------------------------------------------
    ...
    Removes the element with the key that is equivalent to ``key``
    ...
    **Returns**: ``1`` if an element with the key equivalent to ``key`` exists;
    ``0``, otherwise.
...
-----------------------------------------------------
    ...
    If an element with the key equivalent to ``key`` exists, transfers ownership of this element
...
-----------------------------------------------------
    ...
    If an element with the key equivalent to ``key`` exists,
