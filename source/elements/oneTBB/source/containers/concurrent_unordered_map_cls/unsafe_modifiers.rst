...
---------------------------------------------------------------------------------------------
    ...
    Removes the element with the key which compares equivalent with ``key``
...
---------------------------------------------------------------------------------------------
    ...
    If an element with the key which compares equivalent with ``key`` exists,
    ...
    **Returns**: the node handle that owns the extracted element or an empty node handle if
    an element with the key which compares equivalent with ``key`` was not found.
