...
``concurrent_unordered_multimap::key_equal`` is defined as the value of this qualified-id.
...
Otherwise, the type ``concurrent_unordered_multimap::key_equal`` is defined as the value of the
